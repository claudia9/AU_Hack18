...
def main(model_name, restore, log_dir, **kwargs):
    print('Starting training of cifar network')
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Cifar neural network')

    parser.add_argument('--restore', action='store_true',
                        help='If set, variables will be restored from checkpoint')
    parser.add_argument('-m', '--model-name', type=str, default='./checkpoints/cifar-template.ckpt',
